...
| Microphone + system audio -- `--transcriber whisper` | Transcription by whisper.cpp on this machine | **None -- stays on your machine.** The mixed audio is written to `audio.recording_path` (mode 0600) and transcribed locally after the meeting; nothing is streamed anywhere during it. |
